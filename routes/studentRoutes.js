...
const { checkAttendence, getAllStudents, getStudentByName, studentLogin,
    ...
    previousChats, updateProfile, getAllSubjects, getMarks , getAssignments , postComplaint , getAnnouncements , getAllNotes , openPdf} = require('../controller/studentController')
...
router.post('/annoucement', getAnnouncements)

router.post('/notes' , getAllNotes)

router.get('/pdfs/:id' , openPdf)
